...
class AndroidDynamicFeatureLibraryPlugin : Plugin<Project>, BasePlugin {
    ...
    /**
     * Configures the [Android library][com.android.build.api.dsl.DynamicFeatureExtension] extension.
     */
    private fun Project.applyAndroidLibraryExtension() {
        val extension = project.extensions.findByType(DynamicFeatureExtension::class.java) ?: return
        val kotlinOption =
